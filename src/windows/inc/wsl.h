...
#define WSL_LIST_DEVICES_ARG L"--list-devices"
#define WSL_LIST_DEVICES_ARG_ALL_OPTION L"--all"
#define WSL_LIST_DEVICES_HEADER_DEVICE L"DEVICE"
#define WSL_LIST_DEVICES_HEADER_LOCATION L"LOCATION"
#define WSL_LIST_DEVICES_HEADER_STATE L"STATE"
